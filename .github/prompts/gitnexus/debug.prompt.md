---
description: Investigate debug concerns with GitNexus and summarize blast radius before edits.
---

Use GitNexus to perform **debug** analysis before implementing changes.
