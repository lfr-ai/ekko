---
description: Write discipline for committed cross-session agent memory in memories/ — record only verified facts, durable decisions, recurring lessons, and unfinished handoffs, with evidence, and prune stale entries. Use when editing any memories/ file.
applyTo: "memories/**/*.md"
---
