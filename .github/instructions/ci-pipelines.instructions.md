---
description: CI/CD pipeline conventions for GitHub Actions workflows (.github/workflows/) — version pinning, least privilege, secret handling, reusable workflows, and keeping CI gates aligned with the local task runner.
