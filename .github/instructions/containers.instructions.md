---
description: Container image and Compose conventions for Dockerfile/Containerfile and docker-compose files — pinned non-root reproducible images, multi-stage builds, no secrets in layers, and Compose service hygiene.
applyTo: "**/Dockerfile, **/Dockerfile.*, **/*.dockerfile, **/Containerfile, **/Containerfile.*, **/compose*.yaml, **/compose*.yml, **/docker-compose*.yaml, **/docker-compose*.yml"
---
