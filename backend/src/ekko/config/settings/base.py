...
class BaseAppConfig(BaseSettings):
    ...
    # ── GraphQL API ──────────────────────────────────────────
    graphql_allow_get_queries: bool = False
    graphql_enable_ide: bool = True
    graphql_enable_introspection: bool = True
    graphql_batch_max_operations: int = 5
    graphql_max_query_depth: int = 10
    graphql_max_alias_count: int = 25
    graphql_max_token_count: int = 2500
    graphql_max_query_cost: int = 500
    graphql_enable_persisted_operations: bool = False
    graphql_require_trusted_documents: bool = False
    graphql_trusted_operation_hashes: tuple[str, ...] = ()
    graphql_enable_legacy_ws_protocol: bool = True
    graphql_enable_sse_subscriptions: bool = False
    graphql_subscription_auth_required: bool = False
    graphql_subscription_accept_connection_params_user: bool = True
    graphql_subscription_required_roles: tuple[str, ...] = ("admin",)
    rest_stream_endpoints_enabled: bool = False
    rest_stream_deprecation_sunset_rfc3339: str = "2027-01-31T00:00:00Z"
    rest_stream_removal_target_rfc3339: str = "2027-04-30T00:00:00Z"
    ...
    pii_policy_profile: str = "standard"
