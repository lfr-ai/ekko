...
category: "Testing"
tags: ["testing", "cleanup", "clean-architecture", "quality"]
---
...
- Use `Grep`, `Glob`, and read tools; if GitNexus is available, use it for
  call-graph and impact context.
...
- Use Context7 for version-accurate library/framework docs: pytest, Hypothesis,
  FastAPI `TestClient`, Pydantic, SQLAlchemy, Alembic, testcontainers,
  factory-boy — whatever the suite touches.
