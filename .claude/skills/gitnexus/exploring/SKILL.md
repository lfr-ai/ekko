...
```
openspec/specs/
├── context-a/spec.md    → aggregate roots, entities, value objects
├── context-b/spec.md    → domain services, domain events
├── context-c/spec.md    → use cases, orchestration
├── context-d/spec.md    → domain policies and rules
