...
GraphQL-specific observability additions:

- Prometheus alert rules: `observability/prometheus/rules/graphql-alerts.yml`
- Grafana panels (in `ekko-observability-overview`):
	- GraphQL error ratio
	- GraphQL policy rejections + cost p95
